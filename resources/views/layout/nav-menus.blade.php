<ul
    class="navigation-menu rlr-navigation__menu rlr-navigation__menu--main-links">
    <!-- Dropdown menu 1 -->
    <li class="navigation-item {{url()->current() == route('front.home') ? "is-active" : ""}}">
        <a class="navigation-link" href="{{ route('front.home') }}"> Home </a>
    </li>
    <li class="navigation-item {{url()->current() == route('front.tours.index') ? "is-active" : ""}}">
        <a class="navigation-link" href="{{ route('front.tours.index') }}"> Tours </a>
    </li>
    <!-- Mega menu -->
    {{--            <li class="navigation-item has-submenu">--}}
    {{--                <a class="navigation-link" href="#">Destination</a>--}}
    {{--                <ul--}}
    {{--                    class="navigation-megamenu navigation-submenu navigation-megamenu-half">--}}
    {{--                    <li class="navigation-megamenu-container">--}}
    {{--                        <ul class="navigation-tabs">--}}
    {{--                            <li class="rlr-navigation__tabbed-list">--}}
    {{--                                <ul class="navigation-tabs-nav">--}}
    {{--                                    <li class="navigation-tabs-nav-item is-active"><a--}}
    {{--                                            href="#">Africa</a>--}}
    {{--                                    </li>--}}
    {{--                                    <li class="navigation-tabs-nav-item"><a--}}
    {{--                                            href="#">Asia</a></li>--}}
    {{--                                    <li class="navigation-tabs-nav-item"><a--}}
    {{--                                            href="#">Australias</a></li>--}}
    {{--                                    <li class="navigation-tabs-nav-item"><a--}}
    {{--                                            href="#">Europe</a></li>--}}
    {{--                                    <li class="navigation-tabs-nav-item"><a--}}
    {{--                                            href="#">Americas</a></li>--}}
    {{--                                    <li class="navigation-tabs-nav-item"><a href="#">Middle--}}
    {{--                                            East</a></li>--}}
    {{--                                    <li class="navigation-tabs-nav-item"><a href="#">View--}}
    {{--                                            All</a></li>--}}
    {{--                                </ul>--}}
    {{--                            </li>--}}
    ...
    {{--                                                <div--}}
    {{--                                                    class="rlr-icon-text__text-wrapper">--}}
    {{--                                        <span--}}
    {{--                                            class="rlr-icon-text__title"><a--}}
    {{--                                                href="./search-results--left-sidebar.html">--}}
    {{--                                                Botswana</a></span>--}}
    {{--                                                </div>--}}
    {{--                                            </li>                                <li class="rlr-icon-text">--}}
    {{--                                                <div--}}
    {{--                                                    class="rlr-icon-text__text-wrapper">--}}
    {{--                                        <span--}}
    {{--                                            class="rlr-icon-text__title"><a--}}
    ...
    {{--                   href="./home-page.html">Tours</a>--}}
    {{--                <ul class="navigation-dropdown">--}}
    {{--                    <li class="navigation-dropdown-item">--}}
    {{--                        <a class="navigation-dropdown-link"--}}
    {{--                           href="./product-detail-page.html">Single--}}
    {{--                            Tour</a>--}}
    {{--                    </li>--}}
    {{--                    <li class="navigation-dropdown-item">--}}
    {{--                        <a class="navigation-dropdown-link"--}}
    {{--                           href="./search-results--left-sidebar.html">Left--}}
    {{--                            Sidebar</a>--}}
    {{--                    </li>--}}
    {{--                    <li class="navigation-dropdown-item">--}}
    {{--                        <a class="navigation-dropdown-link"--}}
    {{--                           href="./search-results--right-sidebar.html">Right--}}
    {{--                            Sidebar</a>--}}
    {{--                    </li>--}}
    {{--                    <li class="navigation-dropdown-item">--}}
    {{--                        <a class="navigation-dropdown-link"--}}
    {{--                           href="./search-results--no-sidebar.html">No--}}
    {{--                            Sidebar</a>--}}
    {{--                    </li>--}}
    {{--                    <li class="navigation-dropdown-item">--}}
    {{--                        <a class="navigation-dropdown-link"--}}
    {{--                           href="./search-results--3-col.html">Three--}}
    {{--                            Column</a>--}}
    {{--                    </li>--}}
    {{--                </ul>--}}
    {{--            </li>--}}
    ...
    {{--                                <ul class="navigation-list">--}}
    {{--                                    <li--}}
    {{--                                        class="navigation-list-heading rlr-navigation-list-heading--tall">--}}
    {{--                                        <a href="#">Inner Pages</a>--}}
    {{--                                    </li>--}}
    {{--                                    <li class="rlr-icon-text">--}}
    {{--                            <span--}}
    {{--                                class="rlr-step__icon rlr-step__icon--active">--}}
    {{--                                <i--}}
    ...
    {{--                                        About Us</a></span>--}}
    {{--                                            <span--}}
    {{--                                                class="rlr-icon-text__subtext">Add your menu subtext--}}
    {{--                                                            here</span>--}}
    {{--                                        </div>--}}
    {{--                                    </li>                            <li class="rlr-icon-text">--}}
    {{--                            <span--}}
    ...
    {{--                                        Contact Us</a></span>--}}
    {{--                                            <span--}}
    {{--                                                class="rlr-icon-text__subtext">Add your menu--}}
    {{--                                                            subtext here</span>--}}
    {{--                                        </div>--}}
    {{--                                    </li>                            <li class="rlr-icon-text">--}}
    {{--                            <span--}}
    ...
    {{--                                <span--}}
    {{--                                    class="rlr-icon-text__title"><a--}}
    {{--                                        href="./account-pages--signup.html">--}}
    {{--                                        Account Signup</a></span>--}}
    {{--                                            <span--}}
    {{--                                                class="rlr-icon-text__subtext">Add your menu--}}
    {{--                                                            subtext here</span>--}}
    {{--                                        </div>--}}
    ...
    {{--                                <span--}}
    {{--                                    class="rlr-icon-text__title"><a--}}
    {{--                                        href="./account-pages--forgot-password.html">--}}
    ...
    {{--                                <span--}}
    {{--                                    class="rlr-icon-text__title"><a--}}
    {{--                                        href="./account-pages--verification.html">--}}
    ...
    {{--                                <span--}}
    {{--                                    class="rlr-icon-text__title"><a--}}
    {{--                                        href="./review-form-page.html">--}}
    {{--                                        Review a Tiur</a></span>--}}
    {{--                                            <span--}}
    {{--                                                class="rlr-icon-text__subtext">Add your menu--}}
    {{--                                                                subtext here</span>--}}
    {{--                                        </div>--}}
    ...
    {{--                                <span--}}
    {{--                                    class="rlr-icon-text__title"><a--}}
    {{--                                        href="./navigation--html-signup.html">--}}
    {{--                                        Menu Guest User</a></span>--}}
    {{--                                            <span--}}
    {{--                                                class="rlr-icon-text__subtext">Add your menu--}}
    {{--                                                                subtext here</span>--}}
    {{--                                        </div>--}}
    ...
    {{--                    <li class="navigation-dropdown-item">--}}
    {{--                        <a class="navigation-dropdown-link"--}}
    {{--                           href="./single.html">Blog Single</a>--}}
    {{--                    </li>--}}
    {{--                    <li class="navigation-dropdown-item">--}}
    {{--                        <a class="navigation-dropdown-link"--}}
    {{--                           href="./blog-listings--no-sidebar.html">Full--}}
    {{--                            Width--}}
    {{--                            List</a>--}}
    {{--                    </li>--}}
    ...
    {{--                            <li class="navigation-dropdown-item">--}}
    {{--                                <a class="navigation-dropdown-link"--}}
    {{--                                   href="./blog-listings--no-sidebar.html">No Sidebar</a>--}}
    {{--                            </li>--}}
    {{--                            <li class="navigation-dropdown-item">--}}
    {{--                                <a class="navigation-dropdown-link"--}}
    ...
    {{--                    <li class="navigation-dropdown-item">--}}
    {{--                        <a class="navigation-dropdown-link"--}}
    {{--                           href="./blog-listings--left-sidebar.html">Left--}}
    {{--                            Sidebar</a>--}}
    {{--                    </li>--}}
    {{--                    <li class="navigation-dropdown-item">--}}
    {{--                        <a class="navigation-dropdown-link"--}}
    {{--                           href="./blog-listings--right-sidebar.html">Right--}}
    {{--                            Sidebar</a>--}}
    {{--                    </li>--}}
    {{--                    <li class="navigation-dropdown-item">--}}
    {{--                        <a class="navigation-dropdown-link"--}}
    {{--                           href="./blog-listings--no-results.html">Blog--}}
    {{--                            No--}}
    {{--                            Results</a>--}}
    {{--                    </li>--}}
    {{--                </ul>--}}
    {{--            </li>--}}
    {{--            <!-- Dropdown menu 2 -->--}}
    <li class="navigation-item {{url()->current() == route('front.about') ? "is-active" : ""}}">
        <a class="navigation-link" href="{{ route('front.about') }}"> About </a>
    </li>
    <li class="navigation-item {{url()->current() == route('front.contact') ? "is-active" : ""}}">
        <a class="navigation-link" href="{{ route('front.contact') }}"> Contact </a>
    </li>
</ul>
